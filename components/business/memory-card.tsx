  ...
  return (
    <Card className="overflow-hidden bg-gradient-to-br from-surface to-bg-secondary p-5">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <p className="text-xs uppercase tracking-[0.18em] text-text-muted">{item.seasonLabel}</p>
      </div>
      ...
      <Link
        href="/memory"
        className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-text-primary"
      >
        进入 Nerazzurri Memory
